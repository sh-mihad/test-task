...
export default function ModalTask({taskToUPdate, onTaskModalClose , onADDEDIT}) {
...
const [isadd, setIsAdd] = useState(Object.is(taskToUPdate, null));
  ...
  >
    ...
    <div className="mt-16 flex justify-center lg:mt-20">
      ...
      <button
        type="submit"
        className="rounded mx-5 bg-red-500 px-4 py-2 text-white transition-all hover:opacity-80"
        onClick={onTaskModalClose}
      >
       cancel
      </button>
    </div>
